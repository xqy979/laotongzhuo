          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl bg-white aspect-[4/3] border-[8px] border-white/50 backdrop-blur-sm">
              ...
              <div className="absolute inset-0 bg-gradient-to-br from-slate-100 to-slate-200 flex items-center justify-center">
                 <span className="text-slate-400 font-medium">[Factory/Product Hero Image]</span>
              </div>
              ...
              <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur p-6 rounded-xl border border-white/20 shadow-lg">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-2xl font-bold text-slate-900">100万+ <span className="text-sm font-normal text-slate-400">贴</span></p>
                  </div>
                  <div className="h-10 w-px bg-slate-200"></div>
                  <div>
                    <p className="text-sm text-slate-500">合作品牌</p>
                    <p className="text-2xl font-bold text-slate-900">500+ <span className="text-sm font-normal text-slate-400">家</span></p>
                  </div>
                  <div className="h-10 w-px bg-slate-200"></div>
                  <div>
                    <p className="text-sm text-slate-500">成品出货</p>
                    <p className="text-2xl font-bold text-slate-900">3-7 <span className="text-sm font-normal text-slate-400">天</span></p>
                  </div>
                </div>
              </div>
            </div>
